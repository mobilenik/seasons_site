...
class Text1 extends React.Component {
    render() {
        return (
            <div>
                <p>The exhibition for our Summer 2023 course showed of the students successes with drawing, pastels, watercolours and acrylics.</p>
...
class ExSpr23 extends React.Component {
    ...
    componentDidMount() {
        ...
        const imgMap = this.importAll(require.context("../img/exsum23b", false, /\.(png|jpe?g|svg)$/));
        ...
        return <div className="panel">
            <MediaQuery maxWidth={600}>
                ...
                <div className={"panel-body-mob"}>
                    <div className="panel-title">Summer 2023</div>
                    <Text1 />
                    <Lightbox photos={listOfImages} />
                </div>
            </MediaQuery>
            <MediaQuery minWidth={601}>
                <div className="panel-header">Summer 2023 Exhibition</div>
