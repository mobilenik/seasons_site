...
import Pic1 from '../img/exaut23/Ex1.jpeg'
import Pic2 from '../img/exaut23/Ex2.jpeg'
...
class Text1 extends React.Component {
    render() {
        return (
            <div>
                <p>The exhibition for our Autumn 2023 course showed of the students successes with drawing, pastels, watercolours and acrylics.</p>
...
class ExAut23 extends React.Component {
    ...
    componentDidMount() {
        ...
        const imgMap = this.importAll(require.context("../img/exaut23", false, /\.(png|jpe?g|svg)$/));
        ...
        return <div className="panel">
            <MediaQuery maxWidth={600}>
                ...
                <div className={"panel-body-mob"}>
                    <div className="panel-title">Autumn 2023</div>
                    <Text1 />
            ...
            <MediaQuery minWidth={601}>
                <div className="panel-header">Autumn 2023 Exhibition</div>
