...
class Text1 extends React.Component {
    render() {
        return (
            <div>
                <p>The exhibition for our Autumn 2022 course showed of the students successes with drawing, pastels, watercolours and acrylics.</p>
...
class ExAut22 extends React.Component {
    ...
    componentDidMount() {
        ...
        const imgMap = this.importAll(require.context("../img/exaut22", false, /\.(png|jpe?g|svg)$/));
        ...
        return <div className="panel">
            <MediaQuery maxWidth={600}>
                ...
                <div className={"panel-body-mob"}>
                    <div className="panel-title">Autumn 2022</div>
                    <Text1 />
                    <Lightbox photos={listOfImages} />
                </div>
            </MediaQuery>
            <MediaQuery minWidth={601}>
                <div className="panel-header">Autumn 2022 Exhibition</div>
