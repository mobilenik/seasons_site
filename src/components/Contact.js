...
class Text2 extends React.Component {
    render() {
        return (
            <div>
                <p>There are many more Seasons Art Classes across the country.  If you are not in our area and would like to be directed to an art class near you, please visit the central website <u><a href="http://www.theseasonsartclass.com/" target="_blank" rel="noopener noreferrer">here</a></u>.</p>
            </div>
        );
    }
}
